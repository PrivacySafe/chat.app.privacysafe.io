...
<template>
  <!--
    ...
    And it covers the interface rather than replacing it: hiding the subtree
    would stop `<video>` playback in the call window, so turning the phone
    mid-call would drop the picture the user is about to come back to. Here the
    call keeps running behind the notice.
  -->
