...
<script lang="ts" setup>
  ...
  const tooltipText = computed(() =>
    doesAllowAddingContact.value
      ? t('chat.invitation.tooltip.oto.incoming_from_unknown', { address: props.msg.sender })
      : '',
  );
